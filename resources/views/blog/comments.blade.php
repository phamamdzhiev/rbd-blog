<section class="not-format">
    ...
    <form @class(['pointer-events-none opacity-60 user-select-none' => !auth('web')->check()]) class="mb-6">
        <div
            ...
            <textarea id="comment" rows="6"
                      ...
                      placeholder="{{ auth('web')->check() ? 'Write a comment...' : 'Login in order to post a comment'}}" required></textarea>
        </div>
        <button type="submit"
